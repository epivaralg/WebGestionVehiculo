...
@FacesConverter(value = "lineaConverter")
public class LineaConverter implements Converter {

    private LineaFacade ejbFacade;
    ...
    private LineaFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(LineaFacade.class).get();
