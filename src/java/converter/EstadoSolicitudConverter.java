...
@FacesConverter(value = "estadoSolicitudConverter")
public class EstadoSolicitudConverter implements Converter {

    private EstadoSolicitudFacade ejbFacade;
    ...
    private EstadoSolicitudFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(EstadoSolicitudFacade.class).get();
