...
@FacesConverter(value = "tipoComisionConverter")
public class TipoComisionConverter implements Converter {

    private TipoComisionFacade ejbFacade;
    ...
    private TipoComisionFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(TipoComisionFacade.class).get();
